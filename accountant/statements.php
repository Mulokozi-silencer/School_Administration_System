...
<body>
    ...
    <div class="container">
        <div class="feature-card">
            ...
            <h2>Fee Statement Generator</h2>
            <p>Generate comprehensive fee statements for students showing all transactions, payments made, pending balances, and payment history. Export statements as PDF for email distribution or printing.</p>
